...
def main():
    ...
    sample_INPUT_DIR = os.path.join(ROOT_DIR, 'sample/data')
    sample_VIDEO_NAME = "50cm3kg1.mp4"  # Change to your video filename
    input_video_path = os.path.join(sample_INPUT_DIR, sample_VIDEO_NAME)
